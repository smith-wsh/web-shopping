...
//		Goods goods = new Goods(ISBN, gname, number, photo, type, producer, price,
...
//		Goods goods = new Goods(ISBN,"商品一", 1, "1", "1", "1", 1, 1,
//				"2011:01:01",
//				"1", "1");
//		 if (dao.addGoods(goods)) {
//		 System.out.println("+++++++++++++++++++++++");
//		 }
//		 goods = new Goods(ISBN+1,"商品二", 2, "2", "2", "2", 2, 2, "2011:01:01", "2",
//				 "2");
//		 dao.addGoods(goods);
